...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { duration: @concert.duration, event: @concert.event, group_id: @concert.group_id, tickets: @concert.tickets } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { duration: @concert.duration, event: @concert.event, group_id: @concert.group_id, tickets: @concert.tickets } }
